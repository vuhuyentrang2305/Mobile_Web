		...
		if(isset($_POST ['sbm'])){
			if(empty ($_POST ['cat_name'])){
				...
				if(mysqli_num_rows($queryCheck) > 0){ // trg hợp tồn tại bản ghi có tên danh mục mới nhập
					...
					$sqlInsertCate = "INSERT INTO category(cat_name) VALUE ('$cat_name')";// cbi truy vấn
					mysqli_query($conn,$sqlInsertCate);// thực thi truy vấn insert dl vào DB
					header("Location: category.php");// chuyển sang danh sách danh mục
				}
			}
		}
		// $sqlCheck = "SELECT * FROM categories WHERE cat_name=...";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
						...
						<?php
                            ...
                            <input type="submit" name="sbm" value="Thêm mới" class="btn btn-success"></button>
